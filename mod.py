...
STT_MODEL_PATH = "recognizer/models/vosk-model-small-en-us-0.15"
# switch language
if LANGUAGE == "en": 
    STT_MODEL_PATH = "recognizer/models/vosk-model-small-en-us-0.15"
    ...
    STT_MODEL_PATH = "recognizer/models/vosk-model-small-it-0.22"
...
MODEL_TALK = "emilia-en-gemma3:1b"              #    "emilia-qwen3:0.6b" # KO
